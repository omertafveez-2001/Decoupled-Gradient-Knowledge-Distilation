...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        norm_layer = (
            partial(nn.LayerNorm, eps=1e-6) if norm_layer is None else norm_layer
        )
    ...
    def load_pretrained_weights(self, state_dict):
        ...
        self.patch_embed.proj.weight = assign_check(
            self.patch_embed.proj.weight, state_dict["patch_embed.proj.weight"]
        )
        self.patch_embed.proj.bias = assign_check(
            self.patch_embed.proj.bias, state_dict["patch_embed.proj.bias"]
        )
